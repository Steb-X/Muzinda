...
<?php
 ...
 $rs = mysql_query("insert into users(id,name,surname,sex,email,address,username,password,idnumber,status,date,access,department,suspend) values ('NULL','$_POST[name]','$_POST[surname]','$_POST[sex]','$_POST[email]','$_POST[address]','$_POST[username]','$_POST[password]','$id_no','1','$date','2','$_POST[department]','1')") ;
  ?>
  <script language="javascript">
