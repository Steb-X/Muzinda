...
$rs1 = mysql_query("select * from dept,fuel where dept = '$_POST[branch]' and type = '$_POST[branch]'");
 ...
 location = 'index.php?page=department.php'
  ...
  exit;
   ...
   mysql_query("INSERT INTO `levelhq` (`reorder`,`type`) VALUES ('$_POST[amount]','$department')");
$result = mysql_query("INSERT INTO dept(dept,price)VALUES('$department','$_POST[price]')") or die (mysql_error());
if ($result )
{
 ?>
<script language="javascript">
...
<tr>
  <td width="27%"> <span class="style1 style9">Product</span></td>
  <td width="73%">
    <input type="text" name="branch" id="branch" size="30"  /></td>
</tr><tr>
  <td width="27%"> <span class="style1 style9">Price</span></td>
  <td width="73%">
    <input type="text" name="price" id="price" size="30"  /></td>
</tr><tr>
  <td width="27%"> <span class="style1 style9">Intial Amount</span></td>
  <td width="73%">
