...
<div align="center">
	<div class="main_div">
		<div class="main">
			<div class="main_site">
			  <div class="header">Report Pending orders<br />
				  ...
				  <br />
					 ...
					 <table width="100%" border="0" >
					  <tr> 
                        ...
                        <td bgcolor="#CCCCCC" width="125"><font color="#0033CC">Product</font></td> 
                        <td bgcolor="#CCCCCC" width="119"><font color="#0033CC">Quantity</font></td>
                        <td bgcolor="#CCCCCC" width="125"><font color="#0033CC">Order Number</font></td>
...
{
	  $result ="";
	 $result = mysql_query("SELECT * FROM orders where date>='$date' and date<='$date1' and status ='0' order by date ")or die(mysql_query());
...
echo "<tr><td>{$row['product']}</td><td>{$row['quantity']}</td><td>{$row['ordernumber']}</td><td>{$row['date']}</td></tr>";
}
}
