...
$result = mysql_query("INSERT INTO car(reg,model,date,status)VALUES('$_POST[reg]','external','$date','$_POST[access]')") or die (mysql_error());
if ($result)
{
 ?>
...
<table width="50%" border="0" align="center" style="border-bottom:3px solid #000000;">
 ...
 <table width="100%">
  ...
  <table width="50%" align="center"><tr>
            ...
            <td width="140"><span class="style12">Destination</span></td>
            <td width="412"><input type="text" name="destination" id="destination" size="30"  /> 
             </td>
	        </tr>--><tr>
            <td>Status</td>
