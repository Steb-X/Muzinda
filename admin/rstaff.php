...
<div align="center">
	<div class="main_div">
		<div class="main">
			<div class="main_site">
			  <div class="header">Report on radio owners<br />
				  ...
				  <br />
					  ...
					  <tr> 
                        ...
                        <td  width="125">Surname</td>
                                                <td  width="222">Car Reg Number</td>
                                                <td  width="222">Address</td>
...
{
	  $result ="";
	 $result = mysql_query("SELECT * FROM users,radio where radio.dater>='$date' and radio.dater<='$date1' and radio.user=users.username order by radio.dater ")or die(mysql_query());
...
echo "<tr><td>{$row['name']}</td><td>{$row['surname']}</td><td>{$row['reg']}</td><td>{$row['address']}</td><td>{$row['email']}</td><td>{$row['dater']}</td></tr>";
}
}
