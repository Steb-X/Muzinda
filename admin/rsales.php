...
<div align="center">
	<div class="main_div">
		<div class="main">
			<div class="main_site">
			  <div class="header">Report on Payments<br />
				  ...
				  <br />
					 ...
					 <table width="100%" border="0" >
					  <tr> 
                                  ...
                                  <td bgcolor="#CCCCCC" width="119"><font color="#0033CC">quantity</font></td>
                                              <!--<td bgcolor="#CCCCCC" width="222"><font color="#0033CC">ID Number</font></td>

-->					    <td bgcolor="#CCCCCC" width="123"><font color="#0033CC">Order Number</font></td>

                         
                        <td bgcolor="#CCCCCC" width="222"><font color="#0033CC">price</font></td>
                         <td bgcolor="#CCCCCC" width="222"><font color="#0033CC">amount tendered</font></td>
...
{
	  $result ="";
	 $result = mysql_query("SELECT * FROM payment,orders,dept where payment.datep>='$date' and payment.datep<='$date1' and payment.orders=orders.id and dept.dept=orders.product order by payment.datep  ")or die(mysql_query());
...
echo "<tr><td>{$row['product']}</td><td>{$row['quantity']}</td><td>{$row['ordernumber']}</td><td>$price</td><td>$price</td><td>{$row['datep']}</td></tr>";
}
}
